...
require(  [ "jquery", "eshop/widgets/ShoppingCart", "eshop/widgets/EShopAPI", "eshop/widgets/Phresco", "eshop/widgets/WSConfig"], function($, ShoppingCart, EShopAPI, Phresco, WSConfig) {
	...
	test("Testing ShoppingCart with No Of Item", function() {
	...
	test("Testing shoppingcart-widget With No Of Item", function() {
	...
	test("Tesing ShoppingCart with Different Item", function() {
	...
	test("Testing ShoppingCart with Different No Of Products", function() {
