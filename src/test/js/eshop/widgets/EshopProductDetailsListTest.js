...
require([ "jquery", "./ProductDetails", "./EShopAPI", "qunit" ], function($, ProductDetails, EShopAPI, QUnit) {
	 ...
	 */
	test("productdetail-widget unite test case passed.", function() {

		var self = this, initeObj, listener, api, phresco, currentName, currentID, navUL, output1, output2, mainContent, jsonData,apiRef,url,config,webImage,productDetails,imageURL,
		detailImageURL ,youSave, productName, pd , pdUL, pdLI, pdHolder, pdImage, pdLeftHolder, pdHead, pdReviewCount, pdPriceHolder, price, sellPrice, ratingDone, j, starImage, star, btnHolder, reviewA, addToCartA, data, pdDescHolder,pdSpec,pdSpecUL,pdSpecLI1,pdSpecLI2,pdAttrHolder,pdTitle,pdSpecDetail,pdSpecDetailUL, 
		pdSpecDetailLI1, pdSpecDetailLI2, pdSpecDetailLI3, pdSpecDetailLI4, pdSpecDetailLI5, pdSpecDetailLI6, pdSpecDetailLI7, pdSpecDetailLI8, topH3, productdetail;
		// Setup view and call method under test
		productdetail = new ProductDetails();
		api = new EShopAPI();

        api.wsURL = "http://172.16.23.117:2020/eshop";
		...
		api.getProductDetails(1, function(jsonObject){
