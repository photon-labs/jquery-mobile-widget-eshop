...
require(  [ "jquery", "eshop/widgets/MyCart", "qunit" ], function($, MyCart, QUnit) {
	 ...
	 */
	testwithsamedata("Testing MyCart-widget with Product Details", function() {
	...
	testwithdiffdata("Testing MyCart-widget with Same Product With Details", function() {
	...
	testwithdiffproducts("Testing MyCart-widget with Different Products", function() {
