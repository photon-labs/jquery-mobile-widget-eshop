...
require(  [ "jquery", "eshop/widgets/LoginSuccess", "eshop/widgets/EShopAPI", "eshop/widgets/Phresco", "qunit" ], function($, LoginSuccess, EShopAPI, Phresco, QUnit) {
	...
	testWithValidUser("Testing Login-Success widget with Valid User Credentials", function() {
	...
	testwithinvaliduser("Testing Login-Success widget with Invalid User Credentials", function() {
