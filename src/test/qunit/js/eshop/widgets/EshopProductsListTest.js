...
require(  [ "jquery", "./Products", "./EShopAPI", "qunit", "./WSConfig"], function($, Products, EShopAPI, QUnit, WSConfig) {
	 ...
	 */
	testwithsameproductId("Testing Products-widget With CategoryID", function() {
		var products, api, mainContent, navUL, output1, output2, categoryid;
	...
	testwithdiffproductId("Testing Products-widget With Different CategoryID", function() {
		var products, api, mainContent, navUL, output1, output2, categoryid;
		// Setup view and call method under test
		products = new Products();
		api = new EShopAPI();
