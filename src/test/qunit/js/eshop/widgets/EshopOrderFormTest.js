...
require(  [ "jquery", "./OrderForm", "./Phresco", "qunit" ], function($, OrderForm, Phresco, QUnit) {
	 ...
	 */
	testwithdiffdata("Testing order form with Different user details", function() {
	...
	testwithsamedata("Testing order form with User Details", function() {
	...
	testwithemptydata("Testing order form with empty details", function() {
	...
	testwithspecialcharacter("Testing order form with Special Characters in User Details", function() {
