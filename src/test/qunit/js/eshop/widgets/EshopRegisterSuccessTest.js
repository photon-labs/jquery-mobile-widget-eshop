...
require([ "jquery", "eshop/widgets/RegisterSuccess", "eshop/widgets/EShopAPI", "eshop/widgets/Phresco", "qunit" ], function($, RegisterSuccess, EShopAPI, Phresco, QUnit) {
	 ...
	 */
	testForRegisterSuccess("Testing RegisterSuccess-widget unite test case for  RegisterSuccess.", function() {
	 ...
	 testForRegisterFailure("Testing RegisterSuccess-widget unite test case for same RegisterFailure.", function() {
