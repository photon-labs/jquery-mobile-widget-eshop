...
require(  [ "jquery", "eshop/widgets/Menu", "qunit" ], function($, Menu, QUnit) {
	 ...
	 */
	testWithSameItem("Testing Menu-widget With Menu Item", function() {
	...
	testWithDiffItem("Testing Menu-widget With Different Menu Item", function() {
