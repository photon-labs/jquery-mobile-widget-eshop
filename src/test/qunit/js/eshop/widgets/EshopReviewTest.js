...
require(  [ "jquery", "./Review", "./EShopAPI", "./WSConfig", "qunit" ], function($, Review, EShopAPI, WSConfig, QUnit) {
	 ...
	 */
	testwithSameProduct("Testing Review-widget With Same ProductID", function() {
	...
	var  mainContent = $('<div class="mycart_div"></div>'), jsonData, review, api, listener,  productId, valueStr = "value", keyStr = 'key',  commentStr = 'comment', userStr = 'user', commentData = 'commentDate', reviedTitleDiv, userId=1, postReviewText, productReview,
        reviewDiv, avgreviewDiv, starTotal = 0, starCount, i, ratingValue, barWidth = 0, percentageBar, starVal, review_star_ratio1, review_star_lft1Div1, review_star_rht1, review_ratio_bar1, j, reviewDetail, star_bar, star_bar_arrow, aLink, ratingDone, starImage, aSpan1, aDiv, userDiv, commentDateDiv, output1, output2;
		...
		testwithDiffProduct("Testing Review-widget with Different ProductID", function() {
