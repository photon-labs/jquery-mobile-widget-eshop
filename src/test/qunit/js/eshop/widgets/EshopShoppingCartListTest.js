...
require(  [ "jquery", "./ShoppingCart", "./EShopAPI", "./Phresco", "./WSConfig", "qunit" ], function($, ShoppingCart, EShopAPI, Phresco, WSConfig, QUnit) {
	...
	testShoppingCartwithsamecount("Testing ShoppingCart with No Of Item", function() {
		...
		mycart_mid_bu1, clearDiv, productTotal = 0, subTotal = 0, mainContent = $('<div></div>'), shoppingItemLength = 2, subtotalAmount = "", totalAmount = 0, i;
	...
	testShoppingCartwithdiffcount("Testing shoppingcart-widget With No Of Item", function() {
		
		var shoppingcart, api, phrescoapi, output1, output2, shoppingcard_data = {}, productArray = [], detailImageURL, checkoutvaluecol2, checkoutvaluecol4, subtotal, myCart, myCartHead, j, 
		mycart_quality_div, mycart_qua_div, mycart_borderline, cartImage, data, product_left_div, product_head, review_cont, product_contleft, quality_div, mycart_remove_bu, 
		mycart_remove, mycart_quality, mycart_size, mycart_price_div, mycart_price, mycart_subtotal, mycart_btn, mycart_update_view_bu, mycart_mid_bu, mycart_update_view_bu1, 
		mycart_mid_bu1, clearDiv, productTotal = 0, subTotal = 0, mainContent = $('<div></div>'), shoppingItemLength = 1, subtotalAmount = "", totalAmount = 0, i;
	...
	testShoppingCartwithdiffItem("Tesing ShoppingCart with Different Item", function() {
	...
	testShoppingCartwithdiffnoofproducts("Testing ShoppingCart with Different No Of Products", function() {
