...
require([ "jquery", "eshop/widgets/Footer","qunit" ], function($, Footer, QUnit) {
	 ...
	 */
	testWithSameFooter("Testing Footer-widget unite test case for same Footer items.", function() {
	...
	testWithMismatchFooter("Testing Footer-widget unite test case for mismatch Footer items.", function() {
