...
require([ "jquery", "eshop/widgets/Navigation", "qunit" ], function($, Navigation, QUnit) {
	 ...
	 */
	testWithSameNavigation("Testing Navigation-widget for Navigation items.", function() {
	...
	testWithMismatchNavigation("Testing Navigation-widget for Mismatch Navigation items.", function() {
