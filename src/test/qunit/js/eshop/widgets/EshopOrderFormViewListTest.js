...
require(  [ "jquery", "./OrderFormView", "./Phresco", "qunit" ], function($, OrderFormView, Phresco, QUnit) {
	...
	testwithsamedata("Testing orderformview-widget with User Details", function() {
	...
	testwithdiffdata("Testing orderformview-widget with Different User Details", function() {
	...
	testwithemptydata("Testing orderformview-widget with Empty Details in User Details", function() {
	...
	testwithspecialcharacter("Testing orderformview-widget with Special Characters in User Details", function() {
