...
require([ "jquery", "eshop/widgets/Header","qunit" ], function($, Header, QUnit) {
	 ...
	 */
	testWithSameHeader("Testing Header-widget for same header items", function() {
	...
	testWithMismatchHeader(" Testing Header-widget for mismatch header items", function() {
