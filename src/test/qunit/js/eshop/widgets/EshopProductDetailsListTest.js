...
require(  [ "jquery", "./ProductDetails", "./EShopAPI", "./WSConfig", "qunit" ], function($, ProductDetails, EShopAPI, WSConfig, QUnit) {
	 ...
	 */
	testWithSameProduct("Testing productdetail-widget with Same Product", function() {
		...
		equal(output1.html(),output2.html(),"Success - TestCase for ProductDetails passed");
	});
	
	testWithDiffProduct("Testing productdetail-widget For Different Product", function() {
		...
		// Expect that the text was set on the expected element
		equal(output1.html(), output2.html(), "Failure - Mismatch In ProductID");
	});
});